...
ctx.fillRect((cvs.width/2+((coridorsArea/2)-liftCoridorWd)-lineWidth),cvs.height-landHeight-(lineWidth*2)-(groundHeight*floors)+floorHeight,liftCoridorWd, (groundHeight*(floors))-floorHeight)
// COUNTER WEIGHT'S CORIDOR
ctx.fillStyle="#eae5cf"
ctx.fillRect((cvs.width/2-((coridorsArea/2)-counterWgCoridorWd)-lineWidth),cvs.height-landHeight-(lineWidth*2)-(groundHeight*floors)+floorHeight,counterWgCoridorWd, (groundHeight*(floors))-floorHeight)
// FLOOR'S PATTERN
for(let j=1;j<=floors;j++) {
    ctx.fillStyle=`#7c5232`
...
ctx.fillStyle=`#7c5232`
ctx.fillRect((cvs.width/2+((coridorsArea/2)-liftCoridorWd)-(lineWidth*2.5)),cvs.height-landHeight-(lineWidth*2)-(groundHeight*floors)+floorHeight, (lineWidth*1.5),(groundHeight*(floors))-floorHeight)
ctx.fillRect((cvs.width/2+(coridorsArea/2)-(lineWidth)),cvs.height-landHeight-(lineWidth*2)-(groundHeight*floors)+floorHeight,(lineWidth*1.5),(groundHeight*(floors))-floorHeight)
